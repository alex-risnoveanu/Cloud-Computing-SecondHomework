...
namespace Generated {
  public static partial class SummerService
  {
    ...
    {
      get { return global::Generated.SummerServiceReflection.Descriptor.Services[0]; }
    }

    /// <summary>Base class for server-side implementations of SummerService</summary>
    ...
    /// <summary>Client for SummerService</summary>
    public partial class SummerServiceClient : grpc::ClientBase<SummerServiceClient>
    {
      /// <summary>Creates a new client for SummerService</summary>
      /// <param name="channel">The channel to use to make remote calls.</param>
      public SummerServiceClient(grpc::ChannelBase channel) : base(channel)
      {
      }
      /// <summary>Creates a new client for SummerService that uses a custom <c>CallInvoker</c>.</summary>
      /// <param name="callInvoker">The callInvoker to use to make remote calls.</param>
      public SummerServiceClient(grpc::CallInvoker callInvoker) : base(callInvoker)
      {
      }
      /// <summary>Protected parameterless constructor to allow creation of test doubles.</summary>
      protected SummerServiceClient() : base()
      {
      }
      /// <summary>Protected constructor to allow creation of configured clients.</summary>
      /// <param name="configuration">The client configuration.</param>
      protected SummerServiceClient(ClientBaseConfiguration configuration) : base(configuration)
      {
      }
      ...
      {
        return new SummerServiceClient(configuration);
      }
    }
